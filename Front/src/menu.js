        ...
        return (
            <div id="home-menu">
                ...
                <div id="home-menu-icons">
                    <Link class="home-menu-icon" href="/feeds/skill.rss.xml" target="_blank">
                        <img src="/theme/image/rss.png" alt="RSS"/>
                    </Link>
                    <Link class="home-menu-icon" href="https://github.com/dtysky" target="_blank">
                        <img src="/theme/image/github.png" alt="Github"/>
                    </Link>
                    <Link class="home-menu-icon" href="https://cn.linkedin.com/pub/tianyu-dai/a8/818/44a" target="_blank">
                        <img src="/theme/image/linked-in.png" alt="Linked-In"/>
                    </Link>
                    <Link class="home-menu-icon" href="http://psnprofiles.com/dtysky" target="_blank">
